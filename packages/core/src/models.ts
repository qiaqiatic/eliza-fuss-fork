...
export const models: Models = {
    ...
    [ModelProviderName.SECRETAI]: {
        ...
        model: {
            [ModelClass.SMALL]: {
                name: settings.SMALL_SECRET_AI_MODEL || "deepseek-r1:70b",
                stop: [],
                maxInputTokens: 128000,
                maxOutputTokens: 8192,
                temperature: 0.7,
            ...
            [ModelClass.MEDIUM]: {
                name: settings.MEDIUM_SECRET_AI_MODEL || "deepseek-r1:70b",
                stop: [],
                maxInputTokens: 128000,
                maxOutputTokens: 8192,
                temperature: 0.7,
            ...
            [ModelClass.LARGE]: {
                name: settings.LARGE_SECRET_AI_MODEL || "deepseek-r1:70b",
                stop: [],
                maxInputTokens: 128000,
                maxOutputTokens: 8192,
                temperature: 0.7,
    ...
    [ModelProviderName.FUSS]: {
        ...
        model: {
            ...
            [ModelClass.MEDIUM]: {
                name: "fuss-medium-sonnet-20241022",
                stop: [],
                maxInputTokens: 200000,
                maxOutputTokens: 8192,
                frequency_penalty: 0.4,
